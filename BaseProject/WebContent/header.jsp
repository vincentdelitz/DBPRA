<nav class="navbar navbar-default">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="./index.jsp">Festival</a>
		</div>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="./ShiftServlet1">Search Shifts</a></li>
						<li><a href="./InsertProductServlet1">Insert new product</a></li>
					</ul>
            	</li>
            	<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="./StageServlet">Search personal stages</a></li>
